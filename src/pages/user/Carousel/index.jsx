...
import { useCarouselInfoQuery, useAddToCartMutation } from "../../../services/services";
...
function Index() {
  ...
  const handleAdd = async (id) => {
   ...
   if(token) { 
    ...
    if (res.data.status) {
      setLoading(false);
      role === "ADMIN" ? toast.success("You Are Admin") : toast.success(res.data.message);
    } else {
      setLoading(false);
      ...
      {isLoading ? (
        ...
        <div className="d-flex justify-content-center align-items-center vh-100">
          <div className="text-center">
            <Spinner animation="border" role="status" className="text-white mb-3">
